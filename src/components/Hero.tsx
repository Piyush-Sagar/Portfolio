...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative mx-auto max-w-3xl px-6 pt-20 pb-16 md:pt-32 md:pb-24">
      <motion.div
      ...
      >
        ...
        >
          <span className="relative">
            Piyush Sagar
            <motion.span
              className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-500 to-cyan-500 scale-x-0 origin-left"
              initial={{ scaleX: 0 }}
              animate={{ scaleX: 1 }}
